...
class SuperDiscountsList extends StatefulWidget {
  const SuperDiscountsList({Key? key}) : super(key: key);

  @override
  _SuperDiscountsListState createState() => _SuperDiscountsListState();
}

class _SuperDiscountsListState extends State<SuperDiscountsList> {
