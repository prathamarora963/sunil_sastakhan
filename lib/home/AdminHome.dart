...
import '../admin/ManageMerchant.dart';
import '../admin/ManageUser.dart';
import '../admin/SupportCenter.dart';
                            ...
                            if (result != null) {
                              await auth.getCustomerDetailsOnTap(
                                ...
                                setState(() {
                                    ...
                                    ManageMerchant(navFlag: false).launch(context, isNewTask: false, pageRouteAnimation: PageRouteAnimation.Scale);
                                      ...
                                      child: quickAction('Manage Merchant',Icons.store_outlined,onTap: () {

                                      })
                                  ),),
                                  SizedBox(height:15.sp),
                                  InkWell(onTap: () {
                                    ManageUser().launch(context, isNewTask: false, pageRouteAnimation: PageRouteAnimation.Scale);
                                      ...
                                      child: quickAction('Manage User',Icons.supervisor_account_sharp,onTap: () {

                                      })
                                  ),),
                                  SizedBox(height:15.sp),
                                  InkWell(onTap: () {
                                    SupportCenter().launch(context, isNewTask: false, pageRouteAnimation: PageRouteAnimation.Scale);
                                      ...
                                      child: quickAction('Support Center',Icons.support_agent,onTap: () {
