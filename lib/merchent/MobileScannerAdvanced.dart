...
import 'buttons/analyze_image_button.dart';
import 'buttons/pause_button.dart';
import 'buttons/start_stop_button.dart';
import 'buttons/switch_camera_button.dart';
import 'buttons/toggle_flashlight_button.dart';
import 'dialogs/barcode_format_dialog.dart';
import 'dialogs/box_fit_dialog.dart';
import 'dialogs/detection_speed_dialog.dart';
import 'dialogs/detection_timeout_dialog.dart';
import 'dialogs/resolution_dialog.dart';
import 'scanqr/scanned_barcode_label.dart';
import 'scanqr/scanner_error_widget.dart';
import 'scanqr/zoom_scale_slider_widget.dart';
        ...
        children: [
          MobileScanner(
            ...
            onDetect: (result) {
              ...
              // Send data back to the first page
              Get.back(result: result.barcodes.first.rawValue);
            },
          ),
                ...
                child: SizedBox(
                  ...
                  child: StreamBuilder<BarcodeCapture>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<Barcode>? code=barcode?.barcodes;
                      print('neeraj');
                      print(code);
