...
class _SupportCenterState extends State<SupportCenter> with SingleTickerProviderStateMixin {
  // final SupportCenter = Get.put(AuthController());
                ...
                Expanded(
                  child: TabBarView(
                    ...
                    children: [
                      ...
                      _merchantSupportCenter(isActive: false),
                    ],
                  ),
                ),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children:  [
                      Icon(Icons.mail_outline_sharp, size: 17.sp, color: iconColor),
                      SizedBox(width: 10.sp),
                      Container(margin: EdgeInsets.only(top: 0.sp, bottom: 0, left: 0.sp, right: 0.sp),
                        child: Text(
                          "ab@gamil.com",
            ...
            children: [
              ...
              Expanded(
                ...
                Column(mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                  Container(margin: EdgeInsets.only(top: 12.sp, bottom: 0, left: 0.sp, right: 0.sp),
                      child: Text(
                        product,
                        style: TextStyle(
                            fontSize: 15.sp,
                    ...
                    Row(
                      children:  [
                        Icon(Icons.location_on_outlined, size: 17.sp, color: iconColor),
                        SizedBox(width: 8.sp),
                        Container(margin: EdgeInsets.only(top: 0.sp, bottom: 0, left: 0.sp, right: 0.sp),
                          child: Text(
                            "Noida sector 5",
