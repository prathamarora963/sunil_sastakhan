...
import 'admin/ReportingTools.dart';
  ...
  void initState() {
    ...
    try {
      ...
      final newVersion = NewVersionPlus(
        iOSId: 'com.sastakhana.sastakhana', androidId: 'com.sastakhana.sastakhana', androidPlayStoreCountry: "es_ES", androidHtmlReleaseNotes: true, //support country code
      );
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: homeAppbar(_scaffoldKey,context,notifire,name,email,phone,profileimage,loginflag,barHeight,2),
          bottomNavigationBar: BottomNavigationBar(
              ...
              items: [
                BottomNavigationBarItem(
                    ...
                    label: 'Home'.tr),
                BottomNavigationBarItem(
                    icon: Icon(Icons.store_sharp, size: MediaQuery.of(context).size.height / 33,color: _selectedIndex == 1
                        ? buttonColor
                        : notifire.bottommenucolore,),
